...
function LoginPage() {
  ...
  useEffect(() => { if (user) navigate({ to: "/pos", replace: true }); }, [user, navigate]);
    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="hidden lg:flex flex-col justify-between p-12 bg-sidebar text-sidebar-foreground">
        ...
        <div>
          ...
          <p className="mt-4 text-sidebar-foreground/70 max-w-md">Run sales, manage inventory, track customers and grow your business — all in one fast, beautiful app.</p>
        </div>
      ...
      <div className="flex items-center justify-center p-6">
        <Card className="w-full max-w-md p-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">{mode === "signin" ? "Welcome back to your shop." : "Set up your POSify Pro account."}</p>
